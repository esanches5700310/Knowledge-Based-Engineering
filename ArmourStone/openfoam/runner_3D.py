...
Runs a 3D OpenFOAM case using Docker.

The script is used by the KBE application after a 3D OpenFOAM case has already
been generated by ``case_generator_3D.py``. It can also be run manually from
WSL / Ubuntu for testing.
"""
...
# -----------------------------------------------------------------------------
# Functions used to run OpenFOAM inside Docker
# -----------------------------------------------------------------------------
