...
class CFDInputs(ppc.Base):
    ...
    input_openfoam_simulation_type = ppc.Input(
        openfoam_simulation_type,
    ...
    def openfoam_simulation_type(self):
        ...
        value = self.input_openfoam_simulation_type.strip().upper()
...
class ArmourStoneAssessment(ppc.Base):
    ...
    def report(self):
        ...
        """
        filename = "output/" + self.project.project_name + "_" + self.project.project_nr + "_" + self.cfd.openfoam_simulation_type + "_report.pdf"
        ...
        foamfile = {
            "For better visualization": {
                "The .foam file generated by the CFD workflow can be found in the following directory:": f"cases/{self.cfd_case_name}/{self.cfd_case_name}.foam",
        ...
        text = self._format_report_text(inputs, details, summary, foamfile)
